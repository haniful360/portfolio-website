      ...
      <div className='container portfolio_container'>
        <article className='portfolio_item'>
          ...
          <div className='portfolio_item_cta'>
            ...
            <a href="https://github.com/haniful360/espn-sports-website" className='btn github_icon' target='_blank'>
              <span><DiGithubBadge></DiGithubBadge> </span>
              <span>Code Link</span>
            </a>
        ...
        <article className='portfolio_item'>
          ...
          <div className='portfolio_item_cta'>
            <a href="https://github.com/haniful360/biker-laps-client-side" className='btn ' target='_blank'> <DiGithubBadge style={{ marginTop: '.2rem' }}></DiGithubBadge> Code Link</a>
        ...
        <article className='portfolio_item'>
          ...
          <div className='portfolio_item_cta'>
            <a href="https://github.com/haniful360/ema-jhon-website-recap" className='btn ' target='_blank'><DiGithubBadge style={{ marginTop: '.2rem' }}></DiGithubBadge> Code Link</a>
        ...
        <article className='portfolio_item'>
          ...
          <div className='portfolio_item_cta'>
            <a href="https://github.com/haniful360/insta-shohor-js" className='btn ' target='_blank'><DiGithubBadge className='github_icon'></DiGithubBadge> Code Link</a>
        ...
        <article className='portfolio_item'>
          ...
          <div className='portfolio_item_cta'>
            <a href="https://github.com/haniful360" className='btn ' target='_blank'><DiGithubBadge style={{ marginTop: '.2rem' }}></DiGithubBadge>Code Link</a>
        ...
        <article className='portfolio_item'>
          ...
          <div className='portfolio_item_cta'>
            <a href="https://github.com/haniful360/univercity-website" className='btn' target='_blank'><DiGithubBadge></DiGithubBadge>Code Link</a>
